...
registered=_A
flow_dict={_D:_A}
def register():A=MQTTClient(NODE_TYPE+_B+NODE_TAG+'_REG',MQTT_SERVER,MQTT_PORT);A.connect();A.publish(_REGISTRY_SIGN_TOPIC,ujson.dumps({_E:NODE_TAG}))
